                ...
                <div class="row">
                            ...
                            <div class="tab-content mb-20" id="product-detailsContent">
                                <div class="tab-pane fade show active" id="pro-one" role="tabpanel" aria-labelledby="pro-one-tab">
                                    <div class="product__modal-img product__thumb w-img">
                                        <img src='{{asset("images/$prod->product_image")}}' alt="">

                                    </div>
                                </div>
                                <div class="tab-pane fade" id="pro-two" role="tabpanel" aria-labelledby="pro-two-tab">
                                    <div class="product__modal-img product__thumb w-img">
                                        <img src="{{asset('public_theme/assets/img/shop/product/details/details-big-2.jpg')}}" alt="">

                                    </div>
                                </div>
                                <div class="tab-pane fade" id="pro-three" role="tabpanel" aria-labelledby="pro-three-tab">
                                    <div class="product__modal-img product__thumb w-img">
                                        <img src="{{asset('public_theme/assets/img/shop/product/details/details-big-3.jpg')}}" alt="">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="product__modal-content product__modal-content-2">
                            <h4><a href="product-details.html">{{$prod->product_name}}</a></h4>

                            <div class="product__price-2 mb-25">
                                <span>{{$prod->special_price}}JD</span>
                                <span class="old-price">{{$prod->price}}JD</span>
                            </div>
                            ...
                            <div class="product__modal-form mb-30">
                                ...
                                @if($prod['is_available'] == "no")
                                <button  type="submit" class="btn btn-danger" name="add-to-cart" disabled> out of stock </button>
                                 ...
                                 @else
                                    <div class="pro-quan-area d-sm-flex align-items-center">
                                        ...
                                        <div class="product-quantity mr-20 mb-20">
                                            <div class="cart-plus-minus"><input type="text" value="1" name="product_qty" /></div>
                                        </div>
                                        <div class="pro-cart-btn">
                                            <!-- <a href="#" class="add-cart-btn mb-20">+ Add to Cart</a> -->

                                            <button type="submit" class="add-cart-btn mb-20"  name="add-to-cart" style="background-color:black">+Add to order</button>
                                           @endif
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div class="product__tag mb-25">
                                <span>Category:</span>
                                <span><a href="#">{{$cat->category_name}}</a></span>
                                            ...
                                            <div class="latest-comments mb-30">
                                                <ul>
                                                    <li>
                                                        <div class="comments-box">
                                                            <div class="comments-avatar">
                                                                <img src="{{asset('public_theme/assets/img/blog/comments/avater-1.png')}}" alt="">
                                                            </div>
                                                    ...
                                                    <li class="children">
                                                        <div class="comments-box">
                                                            <div class="comments-avatar">
                                                                <img src="{{asset('public_theme/assets/img/blog/comments/avater-2.png')}}" alt="">
                                                            </div>
                                                            <div class="comments-text">
                                                                <div class="avatar-name">
                                                                    <h5>Julias Roy</h5>
                                                    ...
                                                    <li>
                                                        <div class="comments-box">
                                                            <div class="comments-avatar">
                                                                <img src="{{asset('public_theme/assets/img/blog/comments/avater-3.png')}}" alt="">
                                                            </div>
                                                            <div class="comments-text">
                                                                <div class="avatar-name">
                    ...
                    <div class="product__wrapper mb-60">
                        ...
                        <div class="product__content p-relative">
                            <div class="product__content-inner">
                                <h4><a href="{{$val->id}}">{{$val->product_name}}</a></h4>
