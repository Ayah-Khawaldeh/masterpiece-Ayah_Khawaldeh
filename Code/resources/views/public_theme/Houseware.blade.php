                            ...
                            <div class="page__title-inner text-center">
                                ...
                                <div class="page__title-breadcrumb">
                                    ...
                                    <ol class="breadcrumb justify-content-center">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Houseware</li>
                                    </ol>
                                    </nav>
                                </div>
                            </div>
                                        ...
                                        <div class="features__product">
                                            <ul>
                                                <li class="mb-20">
                                                    <div class="featires__product-wrapper d-flex">
                                                        <div class="features__product-thumb mr-15">
                                                            <a href="product-details.html"><img src="{{asset('public_theme/assets/img/shop/product/sm/pro-sm-1.jpg')}}" alt="pro-sm-1"></a>
                                                        </div>
                                                ...
                                                <li class="mb-20">
                                                    <div class="featires__product-wrapper d-flex">
                                                        <div class="features__product-thumb mr-15">
                                                            <a href="product-details.html"><img src="{{asset('public_theme/assets/img/shop/product/sm/pro-sm-2.jpg')}}" alt="pro-sm-2"></a>
                                                        </div>
                                                        <div class="features__product-content">
                                                            <h5><a href="product-details.html">Wooden container Bowl</a></h5>
                                                            <div class="price">
                                                ...
                                                <li class="mb-20">
                                                    <div class="featires__product-wrapper d-flex">
                                                        <div class="features__product-thumb mr-15">
                                                            <a href="product-details.html"><img src="{{asset('public_theme/assets/img/shop/product/sm/pro-sm-3.jpg')}}" alt="pro-sm-3"></a>
                                                        </div>
                                                        <div class="features__product-content">
                                                            <h5><a href="product-details.html">Wooden container Bowl</a></h5>
                                                            <div class="price">
                                        ...
                                        <div class="row custom-row-10">
                                                ...
                                                <div class="product__wrapper mb-60">
                                                    <div class="product__thumb">
                                                        <a href="product-details.html" class="w-img">
                                                            <img src="{{asset('public_theme/assets/img/shop/product/product-1.jpg')}}" alt="product-img">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 custom-col-10">
                                                <div class="product__wrapper mb-60">
                                                    <div class="product__thumb">
                                                        <a href="product-details.html" class="w-img">
                                                            <img src="{{asset('public_theme/assets/img/shop/product/product-2.jpg')}}" alt="product-img">
                                                            <img class="product__thumb-2" src="{{asset('public_theme/assets/img/shop/product/product-9.jpg')}}" alt="product-img">
                                                        </a>
                                                        <div class="product__action transition-3">
                                                            <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist">
                                                                <i class="fal fa-heart"></i>
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 custom-col-10">
                                                <div class="product__wrapper mb-60">
                                                    <div class="product__thumb">
                                                        <a href="product-details.html" class="w-img">
                                                            <img src="{{asset('public_theme/assets/img/shop/product/product-3.jpg')}}" alt="product-img">
                                                            <img class="product__thumb-2" src="{{asset('public_theme/assets/img/shop/product/product-8.jpg')}}" alt="product-img">
                                                        </a>
                                                        <div class="product__action transition-3">
                                                            <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist">
                                                                <i class="fal fa-heart"></i>
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 custom-col-10">
                                                <div class="product__wrapper mb-60">
                                                    <div class="product__thumb">
                                                        <a href="product-details.html" class="w-img">
                                                            <img src="{{asset('public_theme/assets/img/shop/product/product-4.jpg')}}" alt="product-img">
                                                            <img class="product__thumb-2" src="{{asset('public_theme/assets/img/shop/product/product-7.jpg')}}" alt="product-img">
                                                        </a>
                                                        <div class="product__action transition-3">
                                                            <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist">
                                                                <i class="fal fa-heart"></i>
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 custom-col-10">
                                                <div class="product__wrapper mb-60">
                                                    <div class="product__thumb">
                                                        <a href="product-details.html" class="w-img">
                                                            <img src="{{asset('public_theme/assets/img/shop/product/product-5.jpg')}}" alt="product-img">
                                                            <img class="product__thumb-2" src="{{asset('public_theme/assets/img/shop/product/product-1.jpg')}}" alt="product-img">
                                                        </a>
                                                        <div class="product__action transition-3">
                                                            <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist">
                                                                <i class="fal fa-heart"></i>
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 custom-col-10">
                                                <div class="product__wrapper mb-60">
                                                    <div class="product__thumb">
                                                        <a href="product-details.html" class="w-img">
                                                            <img src="{{asset('public_theme/assets/img/shop/product/product-6.jpg')}}" alt="product-img">
                                                            <img class="product__thumb-2" src="{{asset('public_theme/assets/img/shop/product/product-12.jpg')}}" alt="product-img">
                                                        </a>
                                                        <div class="product__action transition-3">
                                                            <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist">
                                                                <i class="fal fa-heart"></i>
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 custom-col-10">
                                                <div class="product__wrapper mb-60">
                                                    <div class="product__thumb">
                                                        <a href="product-details.html" class="w-img">
                                                            <img src="{{asset('public_theme/assets/img/shop/product/product-7.jpg')}}" alt="product-img">
                                                            <img class="product__thumb-2" src="{{asset('public_theme/assets/img/shop/product/product-4.jpg')}}" alt="product-img">
                                                        </a>
                                                        <div class="product__action transition-3">
                                                            <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist">
                                                                <i class="fal fa-heart"></i>
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 custom-col-10">
                                                <div class="product__wrapper mb-60">
                                                    <div class="product__thumb">
                                                        <a href="product-details.html" class="w-img">
                                                            <img src="{{asset('public_theme/assets/img/shop/product/product-8.jpg')}}" alt="product-img">
                                                            <img class="product__thumb-2" src="{{asset('public_theme/assets/img/shop/product/product-3.jpg')}}" alt="product-img">
                                                        </a>
                                                        <div class="product__action transition-3">
                                                            <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist">
                                                                <i class="fal fa-heart"></i>
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 custom-col-10">
                                                <div class="product__wrapper mb-60">
                                                    <div class="product__thumb">
                                                        <a href="product-details.html" class="w-img">
                                                            <img src="{{asset('public_theme/assets/img/shop/product/product-9.jpg')}}" alt="product-img">
                                                            <img class="product__thumb-2" src="{{asset('public_theme/assets/img/shop/product/product-10.jpg')}}" alt="product-img">
                                                        </a>
                                                        <div class="product__action transition-3">
                                                            <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 custom-col-10">
                                                <div class="product__wrapper mb-60">
                                                    <div class="product__thumb">
                                                        <a href="product-details.html" class="w-img">
                                                            <img src="{{asset('public_theme/assets/img/shop/product/product-10.jpg')}}" alt="product-img">
                                                            <img class="product__thumb-2" src="{{asset('public_theme/assets/img/shop/product/product-1.jpg')}}" alt="product-img">
                                                        </a>
                                                        <div class="product__action transition-3">
                                                            <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 custom-col-10">
                                                <div class="product__wrapper mb-60">
                                                    <div class="product__thumb">
                                                        <a href="product-details.html" class="w-img">
                                                            <img src="{{asset('public_theme/assets/img/shop/product/product-11.jpg')}}" alt="product-img">
                                                            <img class="product__thumb-2" src="{{asset('public_theme/assets/img/shop/product/product-2.jpg')}}" alt="product-img">
                                                        </a>
                                                        <div class="product__action transition-3">
                                                            <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist">
                                                                <i class="fal fa-heart"></i>
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 custom-col-10">
                                                <div class="product__wrapper mb-60">
                                                    <div class="product__thumb">
                                                        <a href="product-details.html" class="w-img">
                                                            <img src="{{asset('public_theme/assets/img/shop/product/product-12.jpg')}}" alt="product-img">
                                                            <img class="product__thumb-2" src="{{asset('public_theme/assets/img/shop/product/product-5.jpg')}}" alt="product-img">
                                                        </a>
                                                        <div class="product__action transition-3">
                                                            <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist">
                                                                <i class="fal fa-heart"></i>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-4 col-lg-4">
                                                    <div class="product__thumb">
                                                        <a href="product-details.html" class="w-img">
                                                            <img src="{{asset('public_theme/assets/img/shop/product/product-3.jpg')}}" alt="product-img">
                                                            <img class="product__thumb-2" src="{{asset('public_theme/img/shop/product/product-8.jpg')}}" alt="product-img">
                                                        </a>
                                                        <div class="product__sale ">
                                                            <span class="new">new</span>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-4 col-lg-4">
                                                    <div class="product__thumb">
                                                        <a href="product-details.html" class="w-img">
                                                            <img src="{{asset('public_theme/assets/img/shop/product/product-5.jpg')}}" alt="product-img">
                                                            <img class="product__thumb-2" src="{{asset('public_theme/assets/img/shop/product/product-11.jpg')}}" alt="product-img">
                                                        </a>
                                                        <div class="product__sale ">
                                                            <span class="new">new</span>
											...
											<nav>
                                                <div class="nav nav-tabs justify-content-between" id="nav-tab" role="tablist">
                                                  ...
                                                  <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">
                                                    <div class="product__nav-img w-img">
                                                        <img src="{{asset('public_theme/assets/img/shop/product/quick-view/quick-sm-3.jpg')}}" alt="">
                                                    </div>
                                                  </a>
                                                </div>
                                              </nav>
