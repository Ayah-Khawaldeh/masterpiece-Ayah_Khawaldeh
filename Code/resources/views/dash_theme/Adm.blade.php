                ...
                <div class="col-lg-8 offset-lg-2">
                    <div class="basic-login">
                        ...
                        @csrf
                            ...
                            <input id="email-id" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" />
                            @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <input id="pass" type="text" class="form-control @error('password') is-invalid @enderror" name="phone"  />
                    ...
                    <input class="form-control" style="padding-top: 10px" type="file" placeholder="image" name="image" />
                            ...
                            <div class="mt-10"></div>
                            <button  type="submit" class="os-btn w-100"> {{ __('Register') }}</button>
